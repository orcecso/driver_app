...
/// Strings: 1
///
/// Built on 2026-02-02 at 07:04 UTC
...
/// Translation happens during initialization of the widget (call of ts).
/// Configurable via 'translate_var'.
///
/// Usage:
/// String a = ts.someKey.anotherKey;
/// String b = ts['someKey.anotherKey']; // Only for edge cases!
Translations get ts => LocaleSettings.instance.currentTranslations;
...
///
/// Step 2:
/// final ts = Translations.of(context); // Get ts variable.
/// String a = ts.someKey.anotherKey; // Use ts variable.
/// String b = ts['someKey.anotherKey']; // Only for edge cases!
...
/// context.ts.someKey.anotherKey
extension BuildContextTranslationsExtension on BuildContext {
  Translations get ts => TranslationProvider.of(this).translations;
}
